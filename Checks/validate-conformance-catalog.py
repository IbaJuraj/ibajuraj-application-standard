...
if cat.get('candidate')!='RC1': errors.append('catalog candidate must be RC1')
ids=[]
...
if len(ids)!=108: errors.append(f'expected 108 rules, found {len(ids)}')
if errors:
    print('FAIL – conformance catalog')
    for e in errors: print(' -',e)
    sys.exit(1)
print(f'PASS – conformance catalog 1.8.0 RC1 ({len(ids)} rules)')
